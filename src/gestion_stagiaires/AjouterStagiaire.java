 ...
 * @author charc
 */
public class AjouterStagiaire extends javax.swing.JFrame {
    
   // public static NumberInputVerifier Nu = new NumberInputVerifier();
    ...
    public AjouterStagiaire() {
        initComponents();
            this.setTitle("Ajouter Un Stagiaire");
   // this.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
                ...
                try {                                            
                   ...
                   int  nb;
                    ...
                    try {
                        ...
                        //   if  ( (d.getText().length()==8)&& (d.getText().length()==8)&&(q.getText().length()==8))
                        
                        
                        
                        
                        
                        //  float M  = Bd.NombreStagiaire();
                        
                      
                        Bd.AjouterStagiaire( A,B,C,D,E,F,G,H,I,J,K,L,M,N,O,P,Q,R);
                        JOptionPane.showMessageDialog (null, "Vos donneés ont été enregistré !");
                        
                        
                        /*        else { JOptionPane.showMessageDialog (null, "vérifier les données insérées !!");
                        ...
                        Logger.getLogger(InscriptionAdmin.class.getName()).log(Level.SEVERE, null, e);
                    }
    ...
    private void cKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_cKeyPressed
        // TODO add your handling code here:
            char car= evt.getKeyChar();
        if((car<'0' || car>'9' ) && c.getText().contains(".")
            && (car!=(char)KeyEvent.VK_BACK_SPACE))
        {
            evt.consume();
            JOptionPane.showMessageDialog(null,"seulment numero","validation  "
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AjouterStagiaire.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
